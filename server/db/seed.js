...
async function createInitialPieces() {
  try {
    ...
    await createArtPiece({
      ...
      description: "A cherub statue at Oakland Cemetery in Atlanta, captured on 35mm.",
      tags: ["film"],
    });
    ...
    await createArtPiece({
      ...
      description: "The stained-glass window of a mausoleum at Oakland Cemetery in Atlanta, captured on 35mm.",
      tags: ["film"],
    });
